...
const Building = () => {
  return (
    <main className='buildingcom'>
        <div class="buildingframe9">
    <div class="buildingframe10">
      <div class="buildingrectangle2"></div>
      <div class="buildingget-started">Get started</div>
    </div>
    <div class="buildingframe11">
      <div class="buildingrectangle3"></div>
      <svg
        class="buildingimage4"
        width="16"
        height="16"
        viewBox="0 0 16 16"
        fill="none"
      ...
      <div class="buildingtry-for-free">Try for free</div>
    </div>
  </div>
  <div class="buildingframe12">
    <div class="building-your">
