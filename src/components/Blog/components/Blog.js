...
import './Blog.scss';
import BlogSVG from '../../../UI/BlogSVG/BlogSVG';
...
<div class="blogpageframe4">
    <div class="blogpageframe5">
      ...
      <div class="blogpageframe6">
        ...
        <img class="blogpageimage" src={process.env.PUBLIC_URL + '/pictures/Blog1.png'} alt="Blog1" />
      </div>
    ...
    <div class="blogpageframe13">
      ...
      <div class="blogpageframe6">
        <div class="blogpagerectangle3"></div>
        <img class="blogpageimage" src={process.env.PUBLIC_URL + '/pictures/Blog2.png'} alt="Blog2" />
      </div>
    ...
    <div class="blogpageframe19">
      ...
      <div class="blogpageframe6">
        <div class="blogpagerectangle3"></div>
        <img class="blogpageimage" src={process.env.PUBLIC_URL + '/pictures/Blog3.png'} alt="Blog3" />
      </div>
